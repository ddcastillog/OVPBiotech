...
namespace OVPBiotechSpace
{
    ...
    public abstract class MenuScreenQG : MonoBehaviour
    {
        ...
        [SerializeField] protected MainMenuUIManagerQG m_MainMenuUIManager;
        ...
        protected virtual void Awake()
        {
            ...
            if (m_MainMenuUIManager == null)
                m_MainMenuUIManager = GetComponent<MainMenuUIManagerQG>();
