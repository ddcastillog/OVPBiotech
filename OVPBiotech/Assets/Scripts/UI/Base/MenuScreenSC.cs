...
namespace OVPBiotechSpace
{
    ...
    public abstract class MenuScreenSC : MonoBehaviour
    {
        ...
        [SerializeField] protected MainMenuUIManagerSC m_MainMenuUIManager;
        ...
        protected virtual void Awake()
        {
            ...
            if (m_MainMenuUIManager == null)
                m_MainMenuUIManager = GetComponent<MainMenuUIManagerSC>();
